-- ============================================================
-- Script SQL : NETTOYAGE ET CRÉATION DES TABLES
-- 1. Supprime les tables Sports inutiles
-- 2. Crée toutes les tables nécessaires au projet municipal
...
-- ============================================================
-- Supprimer les tables Sports si elles existent (dans l'ordre pour respecter les clés étrangères)
...
SELECT 'Tables Sports supprimées avec succès!' AS Message;
...
-- Afficher un message de confirmation final
SELECT '✓ Tables Sports supprimées et tables municipales créées avec succès!' AS Message;
