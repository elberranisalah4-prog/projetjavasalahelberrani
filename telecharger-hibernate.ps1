...
if ($successCount -eq $dependencies.Length) {
    ...
    Write-Host ""
    Write-Host "Pour hibernate-core, essayez une version alternative:" -ForegroundColor Yellow
    Write-Host "https://repo1.maven.org/maven2/org/hibernate/orm/hibernate-core/" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "Ou telechargez manuellement depuis:" -ForegroundColor Yellow
    Write-Host "https://hibernate.org/orm/releases/" -ForegroundColor Cyan
}
